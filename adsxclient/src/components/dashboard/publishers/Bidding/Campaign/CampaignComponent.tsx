...
import { Campaign, columns } from '@/components/dashboard/publishers/Bidding/Campaign/columns';
import { DataTable } from '@/components/dashboard/publishers/Bidding/Campaign/data-table';
